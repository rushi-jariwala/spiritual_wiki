...
<!--
The scheduled agent reads this file at 1am IST daily.
It picks the first file(s) from the `## Next` section, ingests them,
moves them to `## Completed`, and updates the next pointer.

Clubbing rule: if the next chapter is < 300 lines, club it with the
following chapter(s) until the combined total reaches ~300+ lines or
a large chapter (≥ 500 lines) is hit.
-->
...
## Next
- [ ] ch-06-journey-towards-disciplehood.md  (705 lines)
...
- [ ] ch-14-guru-vandana.md                  (400 lines)
