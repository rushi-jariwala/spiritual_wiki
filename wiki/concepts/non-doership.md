...
### Not Detachment from Effort, but from Ownership

Non-doership does not mean inaction. The effort is full; what is surrendered is the *claim* to be its author. This is the distinction between the judge (Ch.1) who delivers a verdict without personal agenda and the ego that performs a good deed and waits for applause.
...
- **Before claiming credit for a good act:** pause and ask whether the 'I' needs to own it.
- **When guilt arises after a bad act:** recognise that the act was destiny fructifying, then commit forward without fastening.
