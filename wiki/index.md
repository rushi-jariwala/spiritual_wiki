...
- [[overview|Overview]] — Evolving synthesis of the Hingori Sutras tradition
- [[log|Log]] — Activity history

---

## Concepts
*Core spiritual concepts and philosophy.*

- [[concepts/karma|Karma]] — All action by body, mind, senses, intellect; the accounting framework of the soul
- [[concepts/kriyaman-karma|Kriyaman Karma]] — Present-life karma that fructifies and exhausts instantly
- [[concepts/sanchit-karma|Sanchit Karma]] — Accumulated stored balance across lifetimes; assets and liabilities do not cancel
- [[concepts/prarabdh-karma|Prarabdh Karma]] — Karma drawn from sanchit into the current life as luck and script
- [[concepts/maya|Maya]] — The power of delusion; "that which is not"; the field of duality within which karma operates
- [[concepts/jivaatma|Jivaatma]] — The individual soul; the spark of divinity carrying the karmic balance sheet
