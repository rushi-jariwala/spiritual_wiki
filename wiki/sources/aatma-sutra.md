...
The book's thesis is encapsulated in the Sanskrit phrase *Tat Twam Asi* — "That Thou Art": the consciousness supreme ('That') is what you ('You') already are ('Are'), even if you do not know it, feel it, or want to believe it. The book aims to move the reader from unawareness to acceptance, love, and eventual self-worship of the divinity within.

## Overview

*Aatma Sutra* takes the karmic framework established in *Karma Sutra* and extends it inward — from the mechanics of karma to the anatomy of the self that karma acts upon. It introduces the five-layer model (Isthul Sharir → Sukshma Sharir → Kaarna Sharir → Jivaatma → Aatma), clarifies the distinction between *mukti* (reduced karmashaya) and *moksh* (full dissolution into the whole), and introduces concepts not present in *Karma Sutra*: aura (*shakti*), the *loks* (higher and lower realms), astral travel, the *nirman kaya*, and the progressive practice of self-acceptance and self-worship.

Structured in three parts:
- **Part A — The Nature of Existence**: Theory (anatomy of bodies, thoughts, aura, destiny, astral travel, maya, loks)
- **Part B — Formulas of Evolution**: Practice (vairagya, karm-mukt, empathy, pratipakshbhavana, seva, aura work)
- **Part C — Acceptance to Self-Worship**: Purpose (accepting, loving, and worshipping the divine within)
...
- [[concepts/mukti]] — created
- [[concepts/aatma]] — created
