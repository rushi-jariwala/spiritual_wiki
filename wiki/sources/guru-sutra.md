...
| **First Edition** | 2019 |
| **Raw file** | `raw/guru_sutra_book.md` |

## Nature of This Book

> [!tip] This is a systematic treatise on Guruism.
> *Guru Sutra* is the most focused of the Hingori corpus books on the guru-disciple relationship as a complete system. Where *Karma Sutra* and *Aatma Sutra* introduce the guru-disciple relationship as one element among many, this book treats it as the primary subject. The author writes as both disciple (of Gurudev) and guru — someone who has inhabited both roles for 35 years.
>
> The stated purpose is a "template for those who want to traverse the path from admirer to guru." The tone is deliberately direct ("by-product of the mind of a guru, not a disciple — unflowery and non-poetic").

## Ingestion Status

| Part | Section | Pages | Status |
|---|---|---|---|
| Front matter | GURUDEV — The Spiritual Icon | — | ✅ ingested 2026-04-28 |
| Front matter | Author's Note — An Ode to Femininity | — | ✅ ingested 2026-04-28 |
| | Introduction | 1–3 | ✅ ingested 2026-04-28 |
| **Chapter 1** | Concepts of Guruism | 5–8 | ✅ ingested 2026-04-28 |
...
- The full spectrum from **admirer → follower → devotee → disciple → guru**: each stage defined by its quality of connection and surrender
- **Guruism** as a complete system: not a sentiment but a structured path with stages, obstacles, tests, and mechanisms
- **Avidya** and **maya** as the twin targets of the guru's action — ignorance and delusion, not just information gaps
- The guru's role as uniquely transactional at the karmic level (distinct from teacher or priest)
- **Seva** as the foundational currency of the disciple's path
- Transmission of power: diksha, mantra siddhis, kripa, awelna
- **Faith** as an exclusive and tested commitment
...
> "Since energy flows to and from where attention goes, what you consistently admire, you attract towards yourself."
...
*(None in Introduction or Chapter 1 — Hingori's personal testimony is embedded narrative, filed inline in [[concepts/guru-disciple]].)*

## New Concepts Introduced

- **Admirer → Follower → Devotee → Disciple** spectrum — see [[concepts/guru-disciple]]
- **Human magnet principle** — attention as attractor — see [[concepts/guru-disciple]]
...
- **Keel** — circle of spiritual protection created with directed mental energy — see [[concepts/guru-disciple]]
- **Brahmavidya** — incomprehensible knowledge of the universe; highest level taught in mentorship — see [[concepts/guru-disciple]]
- **Devotion vs. Acceptance** — the arc from shraddha/bhakti (emotion-powered) to centred acceptance (no emotion as power source); the journey "starts with devotion, ends with acceptance" — see [[concepts/guru-disciple]]
- **Sattvic reverence** — unemotional reverence for the guru as the sattvic form of Stage 4; one step from finding no difference between self and guru — see [[concepts/guru-disciple]]
- **Home temple / sanctum sanctorum** — the devotee's practice of a personal photograph-temple; two-way channel at Stage 3 — see [[concepts/guru-disciple]], [[stories/guru-sutra-ch4-devraj-jal]]
- **Internal transmutation of jal** — aspiration to evolve such that every drop of water consumed becomes mantra-energised in the body; not encountered elsewhere in the corpus — see [[stories/guru-sutra-ch4-devraj-jal]]

## Stories Extracted

*(Introduction and Ch.1: none — Hingori's personal testimony filed inline.)*
*(Ch.2: no multi-paragraph stories; anecdotes filed inline in [[concepts/guru-disciple]].)*
...
> *Guru Sutra* states "our biological senses limit our assessment of the absolute reality to about 5%." *Aatma Sutra* Ch.VII cites a scientific figure of less than 0.00000000005% of the electromagnetic spectrum visible to the naked eye. These are measuring different things (senses vs. electromagnetic spectrum) but both point toward the same conclusion: perceived reality is a narrow slice. No contradiction, but the figures differ significantly.

> [!tip] Gradualism vs. binary in guru-disciple framing
> *Karma Sutra* presents the guru-disciple relationship in relatively binary terms (guru / sadguru; disciple or not). *Guru Sutra* introduces a graduated four-stage spectrum (admirer → follower → devotee → disciple). The books are complementary — *Karma Sutra* establishes the mechanics; *Guru Sutra* maps the journey.
...
> [!tip] "As-is-where-is" in two registers
