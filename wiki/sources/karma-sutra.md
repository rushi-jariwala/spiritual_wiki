---
title: Karma Sutra — Cracking the Karmic Code
type: source
tags: [source, hingori, karma, book]
...
| **Distributor (India)** | Bennett, Coleman & Co. Ltd (Times Group) |
| **ISBN** | 978-93-5254-348-9 |
| **Format** | PDF (162 pages) |
| **Raw file** | `raw/Karma Sutra June 2017-edited Final_E-print_19.pdf` |

Dedicated to Gurudev (the [[entities/mahaguru|Mahaguru]]) and framed as a distillation of the karmic principles Gurudev lived and taught. The title puns on an older Sanskrit title familiar in the West, but the content has nothing to do with that earlier work — it is a treatise on karma as balance-sheet accounting for the soul.

## Overview

*Karma Sutra* is Hingori's first major presentation of the Hingori Sutras framework. Its central claim is that karma should be understood not as a moral concept but as an **accounting concept**: every accountable act creates an entry on the [[concepts/jivaatma|jivaatma]]'s balance sheet, assets and liabilities accumulate in [[concepts/sanchit-karma|sanchit]], a slice is drawn as [[concepts/prarabdh-karma|prarabdh]] into each life, and liberation is the state in which the ledger is closed. The book then moves from this framework into concrete chapters on what we owe, what hurts us, what helps us, how a guru can manipulate the equation, and how to do karmic "worksheets" for one's own life.
...
From the PDF, the book's sections are:
...
From Chapter 1:
- [[concepts/karma]] as balance-sheet
- The three types: [[concepts/kriyaman-karma]] · [[concepts/sanchit-karma]] · [[concepts/prarabdh-karma]]
- [[concepts/maya]] as the delusionary field within which karma operates
- [[concepts/jivaatma]] and [[concepts/moksha]] as the actor and the goal
- [[concepts/doer-ship]] and the guilt factor as the binding mechanism
...
None yet — this is the first source ingested. Tensions will be identified as other sources come in.

## Voice and Method

Hingori writes in plain, practical prose with heavy use of business metaphors (balance sheet, profit/loss, assets/liabilities). He supports argument with first-person stories of grace and miracle, and he is epistemically modest — often ending a miraculous anecdote with *"or maybe not."* His view of the guru principle is strongly ecumenical, naming teachers from Indian, Greek, Chinese, Islamic, Jewish, and Christian traditions as legitimate variants of the same truth.

## Endorsement

The book carries a foreword-style endorsement from **Suresh Prabhu** (then Minister of Railways, Government of India):

> In a world where humanity plays second fiddle to capitalism, the Hingori Sutras invoke fresh perspectives and provide a barometer to gauge one's journey through life's adventures... The one insight from the Hingori Sutras that I try to imbibe in my everyday life is to serve others selflessly because I understand that in the service of others lies my evolution as a human being.
